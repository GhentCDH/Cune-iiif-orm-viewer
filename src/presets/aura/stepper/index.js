    ...
    stepperpanel: {
        ...
        number: ({ context }) => ({
            class: [
                ...
                // Colors (Conditional)
                context.visible ? 'text-primary' : 'text-surface-900 dark:text-surface-0', // Adjust colors as needed
        ...
        title: ({ context }) => ({
            class: [
                ...
                // Text
                context.visible ? 'text-primary' : 'text-surface-700 dark:text-surface-0/80',
                'font-medium',
