export default {
    ...
    button: ({ context, props }) => ({
        class: [
            ...
            {
                'text-surface-600 dark:text-white/60 before:bg-transparent': !context.visible,
                'text-surface-800 dark:text-white/80 before:bg-surface-0 dark:before:bg-surface-800': context.visible
            },
            ...
            {
                'hover:text-surface-800 dark:hover:text-white/80': !context.visible && !props.invalid
            },
