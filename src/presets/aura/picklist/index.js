export default {
    ...
    item: ({ context }) => ({
        class: [
            ...
            // Color
            { 'text-surface-700 dark:text-white/80 bg-surface-0 dark:bg-surface-900': !context.visible },
            { 'text-primary-highlight-inverse bg-primary-highlight': context.visible },

            // State
            {
                'hover:bg-surface-100 dark:hover:bg-[rgba(255,255,255,0.03)]': !context.visible,
                'hover:bg-primary-highlight-hover': context.visible
            },
