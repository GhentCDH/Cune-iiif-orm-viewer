export default {
    ...
    stepperpanel: {
        panel: ({ context, parent }) => ({
            class: [context.visible ? 'flex-1' : '', parent.props.orientation === 'vertical' ? 'flex flex-col flex-initial' : '']
        }),
        ...
        number: ({ context }) => ({
            class: [
                ...
                // Colors (Conditional)
                context.visible ? 'bg-primary text-primary-inverse' : 'border border-surface-200 dark:border-surface-700 text-surface-900 dark:text-surface-0', // Adjust colors as needed
                ...
                // Borders
                context.visible ? 'border-0 border-none' : 'border-solid border-2',
        ...
        title: ({ context }) => ({
            class: [
                ...
                // Text
                context.visible ? 'text-surface-900 dark:text-surface-0' : 'text-surface-700 dark:text-surface-0/80',
                'font-bold',
