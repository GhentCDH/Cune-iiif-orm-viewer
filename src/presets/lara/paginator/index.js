export default {
    ...
    pagebutton: ({ context }) => ({
        class: [
            ...
            {
                'bg-primary-highlight border-primary-highlight  text-primary-highlight-inverse': context.visible
            },

            // State
            {
                'hover:bg-surface-50 dark:hover:bg-surface-700/70': !context.disabled && !context.visible,
                'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-primary-400/50 dark:focus:ring-primary-300/50': !context.disabled
            },
