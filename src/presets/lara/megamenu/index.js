export default {
    ...
    content: ({ props, context }) => ({
        class: [
            ...
            //  Colors
            {
                'text-surface-500 dark:text-white/70': !context.focused && !context.visible,
                'text-surface-500 dark:text-white/70 bg-surface-200 dark:bg-surface-600/90': context.focused && !context.visible,
                'text-primary-highlight-inverse bg-primary-highlight': (context.focused && context.visible) || context.visible || (!context.focused && context.visible)
            },

            // Hover States
            {
                'hover:bg-surface-100 dark:hover:bg-surface-600/80': !context.visible,
                'hover:bg-primary-highlight-hover text-primary-highlight-inverse': context.visible
            },
